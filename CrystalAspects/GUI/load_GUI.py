...
"}")
        ...
        self.widget.setGeometry(QtCore.QRect(0, 0, 450, 564))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 424, 538))
        ...
        self.normal_calc_page.setGeometry(QtCore.QRect(0, 0, 473, 564))
        ...
        self.normal_plotting_page.setGeometry(QtCore.QRect(0, 0, 450, 564))
        ...
        self.gridLayout_3.addWidget(self.plot_AR_button, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.plot_GrowthRate_button, 4, 0, 1, 1)
        self.Generate_PCA = QtWidgets.QPushButton(self.plotting_gBox)
        self.Generate_PCA.setEnabled(False)
        self.Generate_PCA.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.Generate_PCA.setFont(font)
        self.Generate_PCA.setObjectName("Generate_PCA")
        self.gridLayout_3.addWidget(self.Generate_PCA, 1, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 339, 680))
...
"color: rgb(255, 255, 255);")
        ...
        self.vis_options_page.setGeometry(QtCore.QRect(0, 0, 315, 404))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 1031, 680))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ar_csv_label.setText(_translate("MainWindow", "Crystal Aspects Information (.CSV) "))
        self.GrowthRate_browse_button.setText(_translate("MainWindow", "Browse/Read"))
        self.plot_AR_button.setText(_translate("MainWindow", "Generate Crystallographic Aspect Ratio Plots"))
        ...
        self.Generate_PCA.setText(_translate("MainWindow", "Generate Morphology Map"))
