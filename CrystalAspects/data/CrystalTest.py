...
p = Plotting()
p.create_plots_folder(
    path="G:/Nathan/Paracetamol/SeriesLarge/20220310_145918/CrystalAspects"
)
p.build_PCAZinng(
    csv="G:/Nathan/Paracetamol/SeriesLarge/20220310_145918/CrystalAspects/aspectratio_energy.csv",
    df="",
    i_plot=True,
)


def summary_compare(summary_csv, aspect_csv="", aspect_df="", cg_version="new"):
