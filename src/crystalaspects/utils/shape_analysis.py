...
class AspectRatioCalc:
    ...
    def measure_crystal_size_xyz(self, coordinates):
        ...
        shape = self.determine_crystal_shape(
            aspect1, aspect2
        )  # Get Zingg definition of crystal
                ...
                for file in files.iterdir():
                    if file.suffix == ".XYZ":
                        ...
                        try:
                            ...
                            crystal_size = self.measure_crystal_size_xyz(
                                xyz
                            )  # Collect OBA data
                            ...
                            size_data = np.concatenate(
                                (sim_num_value, crystal_size, pca_size, savar_size),
                                axis=1,
                            )
