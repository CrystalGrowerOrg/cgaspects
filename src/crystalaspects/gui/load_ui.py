...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.import_pushButton.setMinimumSize(QSize(0, 45))
        ...
        self.gridLayout.addWidget(self.settings_toolButton, 0, 11, 1, 1)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout.addWidget(self.output_textbox, 8, 0, 1, 3)
        ...
        sizePolicy1.setHeightForWidth(self.console_label.sizePolicy().hasHeightForWidth())
        self.console_label.setSizePolicy(sizePolicy1)
        self.console_label.setLayoutDirection(Qt.LeftToRight)

        self.gridLayout.addWidget(self.console_label, 7, 0, 1, 3)
        ...
        sizePolicy2.setHeightForWidth(self.vis_scrollArea.sizePolicy().hasHeightForWidth())
        self.vis_scrollArea.setSizePolicy(sizePolicy2)
        self.vis_scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents_3 = QWidget()
        self.scrollAreaWidgetContents_3.setObjectName(u"scrollAreaWidgetContents_3")
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 870, 754))
        ...
        self.gridLayout_4.addWidget(self.main_frame, 1, 1, 1, 2)

        self.vis_scrollArea.setWidget(self.scrollAreaWidgetContents_3)

        self.gridLayout.addWidget(self.vis_scrollArea, 3, 6, 6, 6)
        ...
        self.open_saved_pushButton.setMinimumSize(QSize(0, 45))
        self.open_saved_pushButton.setBaseSize(QSize(0, 0))
        icon3 = QIcon()
        icon3.addFile(u":/material_icons/material_icons/png/folder-arrow-right.png", QSize(), QIcon.Normal, QIcon.Off)
        self.open_saved_pushButton.setIcon(icon3)
        self.open_saved_pushButton.setIconSize(QSize(20, 20))

        self.gridLayout.addWidget(self.open_saved_pushButton, 0, 10, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.scrollArea_options.sizePolicy().hasHeightForWidth())
        self.scrollArea_options.setSizePolicy(sizePolicy4)
        self.scrollArea_options.setWidgetResizable(True)
        self.scrollAreaWidgetContents_5 = QWidget()
        self.scrollAreaWidgetContents_5.setObjectName(u"scrollAreaWidgetContents_5")
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, 0, 492, 550))
        ...
        sizePolicy5.setHeightForWidth(self.main_toolBox.sizePolicy().hasHeightForWidth())
        self.main_toolBox.setSizePolicy(sizePolicy5)
        ...
        self.batch_analysis_tab.setGeometry(QRect(0, 0, 468, 346))
...
"}")
        ...
        self.plotting_tab.setGeometry(QRect(0, 0, 468, 346))
        ...
        self.crystal_info_tab.setGeometry(QRect(0, 0, 468, 346))
        ...
        sizePolicy6.setHeightForWidth(self.show_info_button.sizePolicy().hasHeightForWidth())
        self.show_info_button.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.fname_label.sizePolicy().hasHeightForWidth())
        self.fname_label.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.fname_comboBox.sizePolicy().hasHeightForWidth())
        self.fname_comboBox.setSizePolicy(sizePolicy8)
        ...
        self.variables_tab.setGeometry(QRect(0, 0, 468, 346))
        ...
        sizePolicy9.setHeightForWidth(self.select_summary_slider_button.sizePolicy().hasHeightForWidth())
        self.select_summary_slider_button.setSizePolicy(sizePolicy9)
        ...
        self.vis_options_tab.setGeometry(QRect(0, 0, 453, 404))
        ...
        icon4 = QIcon()
        icon4.addFile(u":/material_icons/material_icons/png/content-save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.saveFrame_button.setIcon(icon4)
        ...
        sizePolicy10.setHeightForWidth(self.zoom_slider.sizePolicy().hasHeightForWidth())
        self.zoom_slider.setSizePolicy(sizePolicy10)
        font2 = QFont()
        ...
        self.video_options_tab.setGeometry(QRect(0, 0, 468, 346))
        ...
        icon5 = QIcon()
        icon5.addFile(u":/material_icons/material_icons/png/pause-box.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pause_button.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/material_icons/material_icons/png/step-forward-2.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/material_icons/material_icons/png/play-box.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/material_icons/material_icons/png/step-backward-2.png", QSize(), QIcon.Normal, QIcon.Off)
        self.start_simvis_button.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/material_icons/material_icons/png/step-backward.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/material_icons/material_icons/png/step-forward.png", QSize(), QIcon.Normal, QIcon.Off)
        self.next_button.setIcon(icon10)
