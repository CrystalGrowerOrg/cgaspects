...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(":/program_icon/icon.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        sizePolicy.setHeightForWidth(
            self.import_pushButton.sizePolicy().hasHeightForWidth()
        )
        ...
        icon1 = QIcon()
        icon1.addFile(
            ":/material_icons/material_icons/png/folder-arrow-down.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.view_results_pushButton.setObjectName("view_results_pushButton")
        self.view_results_pushButton.setEnabled(False)
        sizePolicy.setHeightForWidth(
            self.view_results_pushButton.sizePolicy().hasHeightForWidth()
        )
        ...
        icon2 = QIcon()
        icon2.addFile(
            ":/material_icons/material_icons/png/folder-arrow-right.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon3 = QIcon()
        icon3.addFile(
            ":/material_icons/material_icons/png/cog.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.xyz_horizontalSlider.setObjectName("xyz_horizontalSlider")
        ...
        self.xyz_spinBox.setObjectName("xyz_spinBox")
        ...
        self.batch_browse_toolButton.setObjectName("batch_browse_toolButton")
        self.batch_browse_toolButton.setMinimumSize(QSize(30, 30))
        icon4 = QIcon()
        icon4.addFile(
            ":/material_icons/material_icons/png/folder-open.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.gridLayout_8.addWidget(
            self.batch_browse_toolButton, 0, 2, 1, 1, Qt.AlignHCenter
        )
        ...
        sizePolicy7.setHeightForWidth(
            self.batch_lineEdit.sizePolicy().hasHeightForWidth()
        )
        ...
        self.batch_visualise_toolButton.setObjectName("batch_visualise_toolButton")
        self.batch_visualise_toolButton.setMinimumSize(QSize(30, 30))
        icon5 = QIcon()
        icon5.addFile(
            ":/material_icons/material_icons/png/cube-scan.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.gridLayout_8.addWidget(
            self.batch_visualise_toolButton, 1, 2, 1, 1, Qt.AlignHCenter
        )

        self.batch_set_pushButton = QPushButton(self.batch_analysis_tab)
        self.batch_set_pushButton.setObjectName("batch_set_pushButton")
        ...
        self.aspect_ratio_pushButton.setObjectName("aspect_ratio_pushButton")
        ...
        sizePolicy8.setHeightForWidth(
            self.aspect_ratio_pushButton.sizePolicy().hasHeightForWidth()
        )
        ...
        self.growth_rate_pushButton.setObjectName("growth_rate_pushButton")
        self.growth_rate_pushButton.setEnabled(False)
        sizePolicy8.setHeightForWidth(
            self.growth_rate_pushButton.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy10.setHeightForWidth(
            self.fname_label.sizePolicy().hasHeightForWidth()
        )
        ...
        icon6 = QIcon()
        icon6.addFile(
            ":/material_icons/material_icons/png/content-save.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        sizePolicy13.setHeightForWidth(
            self.zoom_slider.sizePolicy().hasHeightForWidth()
        )
        ...
        icon7 = QIcon()
        icon7.addFile(
            ":/material_icons/material_icons/png/pause-box.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon8 = QIcon()
        icon8.addFile(
            ":/material_icons/material_icons/png/step-forward-2.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon9 = QIcon()
        icon9.addFile(
            ":/material_icons/material_icons/png/play-box.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon10 = QIcon()
        icon10.addFile(
            ":/material_icons/material_icons/png/step-backward-2.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon11 = QIcon()
        icon11.addFile(
            ":/material_icons/material_icons/png/step-backward.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon12 = QIcon()
        icon12.addFile(
            ":/material_icons/material_icons/png/step-forward.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.import_pushButton.setText(
            QCoreApplication.translate("MainWindow", "   Import", None)
        )
        self.view_results_pushButton.setText(
            QCoreApplication.translate("MainWindow", "   View Results", None)
        )
        self.settings_toolButton.setText(
            QCoreApplication.translate("MainWindow", "Settings", None)
        )
        self.console_label.setText(
            QCoreApplication.translate("MainWindow", "Console", None)
        )
        self.batch_browse_toolButton.setText(
            QCoreApplication.translate("MainWindow", "Browse", None)
        )
        self.batch_label.setText(
            QCoreApplication.translate("MainWindow", "Folder: ", None)
        )
        self.batch_visualise_toolButton.setText(
            QCoreApplication.translate("MainWindow", "View", None)
        )
        self.batch_set_pushButton.setText(
            QCoreApplication.translate("MainWindow", "Set", None)
        )
        self.aspect_ratio_pushButton.setText(
            QCoreApplication.translate("MainWindow", "Aspect Ratios", None)
        )
        self.growth_rate_pushButton.setText(
            QCoreApplication.translate("MainWindow", "Growth Rates", None)
        )
